...
_PROMPTS: dict[str, str] = {
    ...
    "drowsy": (
        ...
        "Answer NO if the driver is holding, looking at, or using a phone or any other object "
        "in their hands — a head tilted down toward a phone/object is phone use or "
        "distraction, not drowsiness, even if it looks similar. "
